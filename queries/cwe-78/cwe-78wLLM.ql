/**
 * @name CWE-78 vulnerability (LLM-enhanced)
 * @description Detects CWE-78 vulnerabilities using LLM-inferred specifications
 * @kind path-problem
 * @id py/cwe-78-llm
...
select sink.getNode(), source, sink, "CWE-78 vulnerability detected"
