/**
 * @name CWE-90 vulnerability (LLM-enhanced)
 * @description Detects CWE-90 vulnerabilities using LLM-inferred specifications
 * @kind path-problem
 * @id py/cwe-90-llm
...
select sink.getNode(), source, sink, "CWE-90 vulnerability detected"
