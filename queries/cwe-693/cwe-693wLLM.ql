/**
 * @name CWE-693 vulnerability (LLM-enhanced)
 * @description Detects CWE-693 vulnerabilities using LLM-inferred specifications
 * @kind path-problem
 * @id py/cwe-693-llm
...
select sink.getNode(), source, sink, "CWE-693 vulnerability detected"
