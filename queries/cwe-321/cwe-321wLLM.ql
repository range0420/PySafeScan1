/**
 * @name CWE-321 vulnerability (LLM-enhanced)
 * @description Detects CWE-321 vulnerabilities using LLM-inferred specifications
 * @kind path-problem
 * @id py/cwe-321-llm
...
select sink.getNode(), source, sink, "CWE-321 vulnerability detected"
