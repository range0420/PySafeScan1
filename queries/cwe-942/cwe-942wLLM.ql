/**
 * @name CWE-942 vulnerability (LLM-enhanced)
 * @description Detects CWE-942 vulnerabilities using LLM-inferred specifications
 * @kind path-problem
 * @id py/cwe-942-llm
...
select sink.getNode(), source, sink, "CWE-942 vulnerability detected"
